...
class DetailACC1 extends Component {
  state = {
        ...
        <div>
          ...
          <div style={{ margin: '20px 15px 100px 15px' }}>
            ...
            <Button
              ...
              onClick={() => { this.gantiStatusWaiting(this.props.match.params.id); }}
            >
              LANJUTKAN
          </Button>
            {this.state.link ? (<Redirect to={`/`} />) : ("")}
...
DetailACC1.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(DetailACC1);