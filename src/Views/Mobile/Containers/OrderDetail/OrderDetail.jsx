...
import Reject from "./svg/minus-sign.svg";
import Pending from "./svg/circular-clock-three-o-clock.svg";
    ...
    if (userRole === 2) {
      return (
        <div>
              ...
              <div>
                ...
                >
                  ...
                  <List>
                    ...
                    <h3 style={{ color: "#bababd" }}>Unprocessed</h3>
                  </List>
          ...
          <div style={{ margin: "20px 15px 100px 15px" }}>
            <Button
              onClick={() => {
                this.gantiStatusRejected(this.props.match.params.id);
              }}
              type="primary"
              inline
              style={{
            ...
            <Button
              onClick={() => {
                this.gantiStatusPending(this.props.match.params.id);
              }}
              type="primary"
              inline
              style={{
            ...
            <Button
              ...
              onClick={() => {
                this.gantiStatusACC1(this.props.match.params.id);
              }}
            >
              ACC1
            </Button>
      ...
      return (
        <div>
          ...
          <div style={{ margin: '20px 15px 100px 15px' }}>
            <Button
              onClick={() => { this.gantiStatusRejected(this.props.match.params.id) }}
              type="primary"
              inline
              style={{
                width: "50px",
            ...
            {this.state.link ? (<Redirect to={`/`} />) : ("")}
            <Button
              onClick={() => { this.gantiStatusPending(this.props.match.params.id) }}
              type="primary"
              inline
              style={{
                width: "50px",
            ...
            <Button
              ...
              onClick={() => { this.gantiStatusACC1(this.props.match.params.id); }}
            >
              ACC1
          </Button>
          </div>
