...
class DetailMyOrder extends Component {
  state = {
    ...
    return (
      <div>
        ...
        <div style={{ textAlign: "center", margin: "20px" }}>
          ...
          <p>{this.props.location.state.orderCode}</p>
        </div>
        ...
        <div>
          <h3 style={{ textAlign: 'center', marginBottom: '15px' }}>Detail Barang</h3>
          {this.state.loading ? (
...
DetailMyOrder.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(DetailMyOrder);