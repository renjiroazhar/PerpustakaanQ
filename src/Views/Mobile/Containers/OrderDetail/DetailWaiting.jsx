...
class DetailWaiting extends Component {
  state = {
        ...
        <div>
          ...
          <div>
            ...
            <InputLabel htmlFor="demo-controlled-open-select">
              ...
              <h3 style={{color: "#766ce1"}}>Waiting</h3>
            </List>
          ...
          <div style={{ margin: '20px 15px 100px 15px' }}>
            ...
            <Button
              ...
              onClick={() => { this.gantiStatusPurchased(this.props.match.params.id); }}
            >
              BELI BARANG
          </Button>
            {this.state.link ? (<Redirect to={`/`} />) : ("")}
...
DetailWaiting.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(DetailWaiting);
