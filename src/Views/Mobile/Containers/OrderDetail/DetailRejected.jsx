...
class DetailRejected extends Component {
  state = {
      ...
      <div>
        ...
        <div>
          {this.state.enableEdit ? (
            ...
            <InputLabel htmlFor="demo-controlled-open-select">
              ...
              <h3 style={{color: "#f0555a"}}>Rejected</h3>
            </List>
        ...
        <div style={{ margin: '20px 15px 100px 15px' }}>
          ...
          <Button
            ...
            onClick={() => { this.gantiStatusAjukan(this.props.match.params.id); }}
          >
            AJUKAN KEMBALI
        </Button>
...
DetailRejected.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(DetailRejected);
